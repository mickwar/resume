...
\begin{minipage}[t]{0.81\textwidth}
    \begin{flushleft}
        ...
        % Mention far fewer skills, if any at all. Might want to condense
        % into a few statements about my statistical background (e.g. competent
        % in the standard approachs such as regression, classification, and
        % theory, but currently interested in developing my machine learning
        % skill set, specializing in neural network techniques)
